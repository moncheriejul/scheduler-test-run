        ...
        <ul>
            <li class="logo">
                <a href="https://codeigniter.com" target="_blank">
                    <img src= "<?php echo base_url('images/tup.png'); ?>" alt='TUP Scheduling'/>
                </a>
            </li>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">About</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Superuser</a></li>
            <li class="menu-item hidden"><a
                    href="https://github.com/codeigniter4/CodeIgniter4/blob/develop/CONTRIBUTING.md" target="_blank">Login</a>
            </li>
        </ul>
    </div>
